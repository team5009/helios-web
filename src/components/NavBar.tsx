...
export default () => { 
    ...
    const setOpenState = (e: any) => {
        const checked = e.target.checked
        if (checked) {
            setOpen('visible opacity-100')
    ...
    return (
        <nav className="flex flex-col md:flex-row w-screen absolute z-[9999999999] box-border px-5 py-2 items-center">
            ...
            <ul 
                className={open + " flex-col md:flex md:visible md:flex-row md:opacity-100 gap-5 mx-auto items-center justify-center w-full bg-white dark:bg-gray-800 md:bg-transparent transition- duration-200"} 
            >
