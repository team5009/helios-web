...
export default () => {
    ...
    return (
        <nav className="flex w-screen absolute z-[9999999999] box-border px-5 py-2 items-center">
            ...
            <ul className="flex gap-5 mx-auto">
                {options.map((option, index) => (
                    <li key={index}>
                        <Link href={`${option.link}`} className="transition-all duration-200 px-5 py-2 hover:bg-orange-400 focus:bg-orange-500 hover:font-semibold rounded-md shadow-md dark:text-white">
                            <span >
                                {option.name}  
                            </span>
                        </Link>
